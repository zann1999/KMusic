    ...
    <div className={cx("boxlogin")}>
      <form className={cx("loginForm")}>
        ...
        <button type="submit" className={cx("button")}>
          <span> Đăng Nhập</span>
          <FontAwesomeIcon className={cx("iconLogin")} icon={faChevronRight} />
        </button>
      </form>
      <div className={cx("optionLogin")}>
        <h4>Đăng Nhập Qua</h4>
        <i className={cx("option1")}>
      ...
      <div className={cx("backgroud")}>
        <span className={cx("backgroud2", "bkg")}></span>
        <span className={cx("backgroud3", "bkg")}></span>
